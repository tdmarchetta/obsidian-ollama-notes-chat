...
**Open loose end:** reply on the 0.7.7 delisting thread requesting re-review now that 0.7.11 is published — that's what restores the directory listing. Deferred: 0.2.1 (edit-and-resend + fork-from-message); context-aware prompt templates.
