...
**Latest: 0.7.14** (published 2026-06-26; `main` at #25, 238 tests) — chat-subheader context + model dropdowns. Full per-release history (0.1.0 → 0.7.14) lives in [CHANGELOG.md](CHANGELOG.md); the durable release gotchas it doesn't capture:
